...
public class TestTransform {
	...
	public void testJson() throws Exception {
		ApiClass rtnAuth = new ApiClass(ApiObject.returnClassDef().
		...
		ApiClasses apiClasses = ApiObject.returnClassDef();
	...
	public void testApiToWsdl() throws Exception {
		ApiObject apiService = ApiObject.returnServiceDef().getInstanceByName(
				"apiService");
		...
		apiService.createList("functions");

		apiService.getList("functions").add(ApiObject.returnServiceDef().
				getClassByName("apiFunction"));
		apiService.getListLast("functions").setString("name",
				"returnAuthentication");
		apiService.getListLast("functions").setString("desc",
				"Authentication Method for Ingram APIs");
		...
		ApiClass rtnAuthResp = new ApiClass(ApiObject.returnClassDef().
				getClassByName("apiClass"));
		...
		rtnAuthResp.getList("fields").add(ApiObject.returnClassDef().
				getClassByName("apiField"));
		...
		rtnExcep.getList("fields").add(ApiObject.returnClassDef().
				getClassByName("apiField"));
		rtnExcep.getListLast("fields").setString("name", "message");
		rtnExcep.getListLast("fields").setString("type", "String");
		rtnExcep.getListLast("fields").setString("desc",
				"Message of this Exception");
		rtnExcep.getListLast("fields").setLong("min", 1L);
		rtnExcep.getListLast("fields").setLong("max", 1L);

		ApiClasses classes = new ApiClasses();

		classes.addClass(rtnExcep);
		classes.addClass(rtnAuth);
