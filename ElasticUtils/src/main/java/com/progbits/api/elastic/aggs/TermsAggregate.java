 ...
 * @author scarr
 */
public class TermsAggregate implements Aggregate {
	...
	public TermsAggregate(String aggName, String aggType, String fieldName,
			Integer size) {
	...
	public void toJson(StringBuilder sb) {
		...
		if (size != null) {
			...
			JsonFunctions.processFieldValue(sb, size, false);
		}
