...
public class ApiUtilsElastic implements ApiUtilsInterface {
    ...
    private static final String API_MODELS = "ds_apimodels";
    private static final String API_MAPPINGS = "ds_apimappings";
    private static final String API_SERVICES = "ds_apiservices";
    ...
    public List<String> retrievePackageElastic(String thisClass) throws ApiException, ApiElasticException {
        ...
        ApiObject rtnObject = elasticUtils.getSearchRecords(API_MODELS, null, "_doc",
                search);
...
//                    }
    ...
    public Map<String, ApiObject> getApiServicesElastic(String service,
        ...
        ApiObject obj = elasticUtils.getSearchRecords(API_SERVICES, null, "_doc", search);
    ...
    public ApiObject getApiMappingElastic(String mapName) throws ApiException, ApiElasticException {
        ...
        ApiObject retMap = elasticUtils.getSearchRecords(API_MAPPINGS, null, "_doc",
                search);

        if (retMap != null && retMap.getLong("total") > 0) {
